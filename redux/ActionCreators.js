...
export const postFavorite = paintingId => dispatch => {
    setTimeout(() => {
        dispatch(addFavorite(paintingId));
    }, 2000);
};

export const addFavorite = paintingId => ({
    type: ActionTypes.ADD_FAVORITE,
    payload: paintingId
});

export const deleteFavorite = paintingId => ({
    type: ActionTypes.DELETE_FAVORITE,
    payload: paintingId
}); 

export const postComment = (paintingId, rating, author, text) => dispatch => {
...
export const postCart = paintingId => dispatch => {
    setTimeout(() => {
        dispatch(addCart(paintingId));
    }, 2000);
};

export const addCart = paintingId => ({
    type: ActionTypes.ADD_CART,
    payload: paintingId
});

export const deleteCart = paintingId => ({
